...
impl I18n {
    ...
    pub fn diagnostics_refresh(self) -> &'static str {
        self.t("diagnostics_refresh")
    }
    pub fn ok(self) -> &'static str {
        self.t("ok_label")
    }
    pub fn warning(self) -> &'static str {
        self.t("warning_label")
    }
    ...
    pub fn home_action_block(self) -> &'static str {
        self.t("home_action_block")
    }
    pub fn home_action_unblock(self) -> &'static str {
        self.t("home_action_unblock")
    }
    pub fn home_action_refresh(self) -> &'static str {
        self.t("home_action_refresh")
    }
    pub fn home_action_exit(self) -> &'static str {
        self.t("home_action_exit")
    }
    pub fn site_empty(self) -> &'static str {
        self.t("site_empty")
    }
    pub fn add_site_prompt(self) -> &'static str {
        self.t("add_site_prompt")
    }
    pub fn selected_label(self) -> &'static str {
        self.t("selected_label")
    }
    pub fn site_add_action(self) -> &'static str {
        self.t("site_add_action")
    }
    pub fn site_remove_action(self) -> &'static str {
        self.t("site_remove_action")
    }
    pub fn site_move_selection(self) -> &'static str {
        self.t("site_move_selection")
    }
    pub fn manage_label(self) -> &'static str {
        self.t("manage_label")
    }
    pub fn schedule_controls(self) -> &'static str {
        self.t("schedule_controls")
    }
    pub fn weekends_label(self) -> &'static str {
        self.t("weekends_label")
    }
    pub fn weekends_on(self) -> &'static str {
        self.t("weekends_on")
    }
    pub fn weekends_off(self) -> &'static str {
        self.t("weekends_off")
    }
    ...
    pub fn streak_current(self) -> &'static str {
        self.t("streak_current")
    }
    pub fn streak_best(self) -> &'static str {
        self.t("streak_best")
    }
    pub fn streak_last_break(self) -> &'static str {
        self.t("streak_last_break")
    }
    pub fn streak_last_break_reason(self) -> &'static str {
        self.t("streak_last_break_reason")
    }
    pub fn streak_total_breaks(self) -> &'static str {
        self.t("streak_total_breaks")
    }
    pub fn streak_days(self) -> &'static str {
        self.t("streak_days")
    }
    pub fn streak_never_broken(self) -> &'static str {
        self.t("streak_never_broken")
    }
